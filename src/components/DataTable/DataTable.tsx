...
export const DataTable = ({ data, updateReloadState }: Props) => {
  ...
  return (
    <div className="container mx-auto pt-2 pb-10">
      <div className="relative overflow-x-auto shadow-sm sm:rounded-md">
            ...
            <tbody>
              {data.map((item) => (
                ...
                >
                  ...
                  >
                    <Link to={item.fullUrl}>{item.fullUrl}</Link>
                  </th>
                  <th
                    scope="row"
                    className="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white"
